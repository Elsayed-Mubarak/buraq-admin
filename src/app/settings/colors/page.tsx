  ...
  return (
    <div className="flex justify-start">
      ...
      <div className=" border-gray-200 px-4 py-5 sm:px-6 rounded-md max-w-lg">
        ...
        {/* Accent Colors */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Accent</h3>
            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  value={colors.accentPrimary}
                  onChange={(e) => handleCodeInputChange(e, "accentPrimary")}
                />
              </div>
            </div>
            {/* Secondary Accent */}
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.accentSecondary}
                  onChange={(e) => handleCodeInputChange(e, "accentSecondary")}
                />
              </div>
            </div>
            {/* Dark Accent */}
              ...
              <div className="flex flex-col items-center">
                <div className="w-8 h-8 rounded-md border border-gray-300 cursor-pointer flex items-center justify-center">
                  <input
                    ...
                    onChange={(e) => handleColorPickerChange(e, "accentDark")}
                    className="w-full h-full rounded-md cursor-pointer appearance-none border-none p-0"
                  />
                </div>
                <input
              ...
              <div className="flex flex-col items-center">
                <div className="w-8 h-8 rounded-md border border-gray-300 cursor-pointer flex items-center justify-center">
                  <input
                    ...
                    onChange={(e) => handleColorPickerChange(e, "textPrimary")}
                    className="w-full h-full rounded-md cursor-pointer appearance-none border-none p-0"
                  />
                </div>
                <input
            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.successPrimary}
                  onChange={(e) => handleCodeInputChange(e, "successPrimary")}
                />
              </div>
            </div>
            {/* Secondary Success */}
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.successSecondary}
                  onChange={(e) => handleCodeInputChange(e, "successSecondary")}
                />
              </div>
            </div>
            <div></div>
        ...
        {/* Failure Colors */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Failure</h3>
          <div className="mt-4 grid grid-cols-3 gap-x-4">
            {" "}
            {/* Added mt-4 here */}
            {/* Primary Failure */}
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.failurePrimary}
                  onChange={(e) => handleCodeInputChange(e, "failurePrimary")}
                />
              </div>
            </div>
            {/* Secondary Failure */}
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.failureSecondary}
                  onChange={(e) => handleCodeInputChange(e, "failureSecondary")}
                />
              </div>
            </div>
            <div></div>
            ...
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.warningPrimary}
                  onChange={(e) => handleCodeInputChange(e, "warningPrimary")}
                />
              </div>
            </div>
            {/* Secondary Warning */}
            <div>
              ...
              <div className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="shadow appearance-none border rounded py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm w-24 text-center mt-1"
                  value={colors.warningSecondary}
                  onChange={(e) => handleCodeInputChange(e, "warningSecondary")}
                />
              </div>
            </div>
            <div></div>
