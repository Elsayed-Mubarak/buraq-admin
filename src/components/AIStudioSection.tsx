    ...
    return (
        <div className="mt-6">
            <div className="grid grid-cols-2 gap-x-6 gap-y-4 mt-2">
                ...
                <NumberInput label="AI Studio Knowledge bases" id="ai-studio-knowledge" disabled placeholder="0" />
                <SelectInput
                    id="ai-models"
                    label="AI Models"
                    ...
                    disabled
                />
                <NumberInput label="Data sources" id="data-sources" disabled placeholder="0" />
